...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        Frame frame2 = new Frame(name: 'gg1', height: 450, streamSource: '1717', width: 800, positionX: 70, positionY: 600, sourceType: Sources.GG, type: "stream")
        Frame frame3 = new Frame(name: 'gg1', height: 450, streamSource: '1717', width: 800, positionX: 170, positionY: 600, sourceType: Sources.GG, type: "stream")
        Frame frame4 = new Frame(name: 'gg1', height: 450, streamSource: 'Abver', width: 100, positionX: 770, positionY: 300, sourceType: Sources.GG, type: "chat")
