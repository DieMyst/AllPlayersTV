...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        Frame frame8 = new Frame(name: 'gg567', height: 450, streamSource: 'http://www.goodgame.ru/player.php?1717', width: 800, positionX: 170, positionY: 300)
        Frame frame9 = new Frame(name: 'gg58', height: 450, streamSource: 'http://www.goodgame.ru/player.php?1717', width: 800, positionX: 270, positionY: 200)
        Frame frame10 = new Frame(name: 'gg456', height: 450, streamSource: 'http://goodgame.ru/chat/Abver', width: 100, positionX: 770, positionY: 700)
        //как узнавать id стримера?
        /*<iframe frameborder="0" width="800" height="450" src="http://www.goodgame.ru/player.php?1717"></iframe>*/
